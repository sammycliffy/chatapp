...
import 'package:speso_chatapp/features/auth/controllers/login_controller.dart';
import 'package:speso_chatapp/features/auth/views/verification.dart';
...
void _navigateToVerificationPage(BuildContext context, String phone) {
  Navigator.of(context).pushAndRemoveUntil(
    MaterialPageRoute(builder: (builder) => VerificationPage(phone: phone)),
    (route) => false,
  );
}
        ...
        children: [
          ...
          Padding(
            ...
            child: RichText(
              ...
              text: TextSpan(
                ...
                children: [
                  const TextSpan(
                    text: 'ChatApp will need to verify your phone number. ',
                  ),
                  TextSpan(
          ...
          Padding(
            ...
            child: GreenElevatedButton(
              onPressed: () =>
                  _navigateToVerificationPage(context, phoneNumber),
              text: 'Next',
            ),
          ),
        ],
