...
import 'package:speso_chatapp/features/chat/models/attachement.dart';
import 'package:speso_chatapp/features/chat/models/message.dart';
import 'package:speso_chatapp/features/chat/models/recent_chat.dart';
import 'package:speso_chatapp/features/chat/views/chat.dart';
import 'package:speso_chatapp/features/home/views/contacts.dart';
import 'package:speso_chatapp/shared/models/user.dart';
import 'package:speso_chatapp/shared/repositories/download_service.dart';
import 'package:speso_chatapp/shared/repositories/firebase_firestore.dart';
import 'package:speso_chatapp/shared/repositories/push_notifications.dart';
...
class HomePageContactsList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //       descriptionList[1] = ' and ${users[2]} are on ChatApp';
    //     } else if (userCount > 1) {
    //       descriptionList[0] = users.join(' and ');
    //       descriptionList[1] = ' are on ChatApp';
    //     } else {
    //       descriptionList[0] = '${users.first}';
    //       descriptionList[1] = ' is one ChatApp.';
    //     }
